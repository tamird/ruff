...
//! a different narrowing constraint at different points in a file.
//!
...
impl NarrowingConstraintsBuilder {
    ...
    pub fn mark_used(&mut self, node: ScopedNarrowingConstraint) {
    ...
    pub fn add_atom(&mut self, predicate: ScopedPredicateId) -> ScopedNarrowingConstraint {
    ...
    pub fn add_negated_atom(&mut self, predicate: ScopedPredicateId) -> ScopedNarrowingConstraint {
        if predicate == ScopedPredicateId::ALWAYS_FALSE {
            ALWAYS_TRUE
        } else if predicate == ScopedPredicateId::ALWAYS_TRUE {
            ALWAYS_FALSE
